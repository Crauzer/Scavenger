        ...
        public override DataTemplate SelectTemplate(object item, DependencyObject container)
        {
            if ( container is FrameworkElement element && item is BinTreePropertyViewModel propertyViewModel)
            {
                return propertyViewModel switch
                {
                    ...
                    BinTreeWadEntryLinkViewModel _ => element.FindResource("BinTreeWadEntryLinkTemplate") as DataTemplate,
                    BinTreeHashViewModel _ => element.FindResource("BinTreeHashTemplate") as DataTemplate,
                    ...
                    BinTreeObjectLinkViewModel _ => element.FindResource("BinTreeObjectLinkTemplate") as DataTemplate,
